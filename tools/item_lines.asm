...
.gba
.thumb
.create "item-lines.bin", CODE_ADDRESS
FormatHook:
    mov r3,r12
    push {r4-r7,lr}
    sub sp,108
...
@@icon:
    ...
    b @@reset
@@style:
    ; Name controls have zero pixel width, but still occupy history bytes.
    mov r1,r4
    add r1,1
    cmp r1,r5
    bhs @@fail
...
.align 4
IconWidths:
    .db 9,9,9,8,8,9,9,9,8,9,9,9,9,9,9,8
.align 4
AcquisitionRecord:
    .word 0,0,0,1

WorldHook:
    ; Only the owned acquisition call using the known obtained template.
    push {r0-r7,lr}
    sub sp,84
    mov r1,lr
    ldr r2,=0x08062D65
    ...
    mov r3,0
    bl PreviousEntry
    ; Reject full/truncated scratch, including terminator at limit.
    mov r4,sp
    mov r5,r4
    add r5,79
@@complete:
...
@@measure:
    mov r0,sp
    mov r1,r5
    ldr r2,=AcquisitionRecord
    bl JoinSpan
    cmp r0,0
    beq @@resume
    ; Source is this caller's mutable printf buffer. Keep $t intact.
    ldr r1,[sp,84]
@@replace:
    ldrb r0,[r1]
    cmp r0,0
...
@@resume:
    ...
    pop {r3}
    mov lr,r3
    ; Replay the displaced native prologue and call.
    push {r4,lr}
    mov r4,r0
    bl WorldWait
    ldr r3,=0x0806229D
