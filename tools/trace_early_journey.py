"""Regression replay on the journey build: natural opening, escort and first chief meeting."""
import argparse
...
def capture():
    mgba.log.silence();rom=(OUTPUT/'torneko3-early-journey-english.gba').read_bytes();build=load_json(OUTPUT/'english-build.json')
