...
public class InspectJourneyReaders extends GhidraScript {
    @Override protected void run() throws Exception {
        ...
        for(int i=1;i<args.length;i+=2) {
            ...
            if (getInstructionAt(entry)==null) currentProgram.getProgramContext().setValue(currentProgram.getRegister("TMode"),entry,entry,BigInteger.ONE);
            disassemble(entry);
